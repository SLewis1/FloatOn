  ...
  if (sensorValue == 1)
    {
      ...
      strncpy(radiopacket, "HIGH", sizeof(radiopacket));
    }
  else
    {
      Serial.println("detected low");
      strncpy(radiopacket, "LOW " , sizeof(radiopacket));
    }
  
  
  Serial.print("----Sending "); Serial.println(radiopacket); Serial.println("");
